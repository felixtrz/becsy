...
export class Buffers {
	...
	register(
		key: string,
		length: number,
		ArrayType: typeof Int8Array,
		update?: (array: Int8Array) => void,
		filler?: number,
	): Int8Array;
	...
	register(
		key: string,
		length: number,
		ArrayType: typeof Int16Array,
		update?: (array: Int16Array) => void,
		filler?: number,
	): Int16Array;
	...
	register(
		key: string,
		length: number,
		ArrayType: typeof Float64Array,
		update?: (array: Float64Array) => void,
		filler?: number,
	): Float64Array;
